...
public class Shipment {
    ...
    public Shipment(String MsgDateTime,
                    String Sender,
                    String Receiver,
                    com.youngliving.model.ShipmentDetails[] ShipmentDetails) {
    ...
    public com.youngliving.model.ShipmentDetails[] GetShipmentDetails() {
        return ShipmentDetails;
    }

    public void setShipmentDetails(com.youngliving.model.ShipmentDetails[] ShipmentDetails) {
        this.ShipmentDetails = ShipmentDetails;
    }
